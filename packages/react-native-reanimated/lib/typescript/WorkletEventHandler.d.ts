...
declare class WorkletEventHandlerNative<Event extends object>
...
declare class WorkletEventHandlerWeb<Event extends object>
  implements IWorkletEventHandler<Event>
{
  eventNames: string[];
  listeners:
...
export declare const WorkletEventHandler:
  | typeof WorkletEventHandlerNative
  | typeof WorkletEventHandlerWeb;
export {};
