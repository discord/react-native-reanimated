...
export declare function createCustomKeyFrameAnimation(
  keyframeDefinitions: KeyframeDefinitions
): string;
export declare function createAnimationWithInitialValues(
 ...
 */
export declare function TransitionGenerator(
