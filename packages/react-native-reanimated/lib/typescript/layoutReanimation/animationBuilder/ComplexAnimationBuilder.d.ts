...
export declare class ComplexAnimationBuilder extends BaseAnimationBuilder {
  ...
  /**
   * Lets you change the easing curve of the animation. Can be chained
  ...
  /**
   * Enables the spring-based animation configuration. Can be chained
   * alongside other [layout animation
   * modifiers](https://docs.swmansion.com/react-native-reanimated/docs/fundamentals/glossary#layout-animation-modifier).
   *
  ...
  /**
   * Lets you adjust overshoot clamping of the spring. Can be chained
   * alongside other [layout animation
   * modifiers](https://docs.swmansion.com/react-native-reanimated/docs/fundamentals/glossary#layout-animation-modifier).
   *
   ...
   * modifiers](https://docs.swmansion.com/react-native-reanimated/docs/fundamentals/glossary#layout-animation-modifier).
   *
   * @param restDisplacementThreshold - The displacement below which the
