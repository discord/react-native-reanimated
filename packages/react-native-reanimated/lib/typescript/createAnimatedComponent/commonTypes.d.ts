...
export interface IAnimatedComponentInternal {
  ...
  /**
   * Used for Shared Element Transitions, Layout Animations and Animated
   * Styles. It is not related to event handling.
   */
  getComponentViewTag: () => number;
  /**
   * A function that will update the components state (the state is used for
   * the style prop)
   */
