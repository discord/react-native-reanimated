...
export declare function assertEasingIsWorklet(
...
export declare function recognizePrefixSuffix(
  value: string | number
): RecognizedPrefixSuffix;
export declare function getReduceMotionFromConfig(
  config?: ReduceMotion
): boolean;
/**
 ...
 */
export declare function getReduceMotionForAnimation(
  config?: ReduceMotion
): boolean | undefined;
...
> = T extends StyleLayoutAnimation
  ...
  : U | (() => U) | AnimatableValue;
export declare function defineAnimation<
  T extends AnimationObject | StyleLayoutAnimation, // type that's supposed to be returned
  U extends AnimationObject | StyleLayoutAnimation = T,
>(starting: AnimationToDecoration<T, U>, factory: () => T): T;
declare function cancelAnimationWeb<TValue>(
