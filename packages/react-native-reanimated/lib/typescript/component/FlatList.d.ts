...
declare const AnimatedFlatList: React.ComponentClass<
  import('../helperTypes').AnimateProps<FlatListProps<unknown>>,
  any
>;
...
export declare const ReanimatedFlatList: <ItemT = any>(
