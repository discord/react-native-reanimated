...
export interface Mutable<Value = unknown> extends SharedValue<Value> {
   ...
   * the provided new value. All other places should only attempt to modify
   * the mutable by assigning to `value` prop directly or by calling the `set`
   * method.
   */
  _value: Value;
}
 ...
 */
export declare function isWorkletFunction<
  Args extends unknown[] = unknown[],
  ReturnValue = unknown,
