...
export class LayoutAnimationConfig extends Component {
  getMaybeWrappedChildren() {
    return Children.count(this.props.children) > 1 && this.props.skipExiting ? Children.map(this.props.children, child => <LayoutAnimationConfig itemKey={this.props.itemKey} skipExiting>{child}</LayoutAnimationConfig>) : this.props.children;
  }
  ...
  render() {
    ...
    return <SkipEntering itemKey={this.props.itemKey} shouldSkip={this.props.skipEntering}>
        {children}
      </SkipEntering>;
  }
}
